    ...
    >
      ...
      <div className="flex items-center gap-2">
        <motion.button
          ...
          className="flex items-center gap-2 px-3 py-2 rounded-md bg-background border text-sm font-medium text-foreground hover:shadow-md shadow-foreground transition-shadow duration-300"
        >
