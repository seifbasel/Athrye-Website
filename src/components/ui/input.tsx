    ...
    return (
      <input
        ...
        className={cn(
          ...
          variant === "default" &&
            "rounded-xl border border-border bg-card/90 px-3 py-2 shadow-soft focus-visible:ring-2 focus-visible:ring-ring",
          variant === "ghost" &&
            "bg-transparent border-none p-0 shadow-none focus-visible:ring-0",
          {
