...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-card/92 px-6 py-8 shadow-soft backdrop-blur-md md:px-8 md:pl-14">
      <div className="mx-auto flex w-full max-w-360 flex-col gap-6">
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-xl space-y-3">
              <div className="inline-flex items-center gap-3 rounded-2xl border border-border/80 bg-card px-3 py-2 shadow-soft">
                ...
                <div>
                  <p className="font-playfair text-lg font-bold text-foreground">Coinat</p>
              ...
              <p className="text-sm font-montserrat leading-relaxed text-muted-foreground">
                A curated home for authenticated coins, collector-grade history, and
                modern numismatic discovery.
              </p>
            </div>
        ...
        <div className="flex flex-col gap-2 border-t border-border/70 pt-4 text-xs font-montserrat text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <p>(c) {year} Coinat. All rights reserved.</p>
          <p>Authenticated pieces. Transparent provenance. Collector-first experience.</p>
        </div>
      </div>
    </footer>
  );
